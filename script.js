...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function initializeBoxes() {
    ...
    addToCartBtn.addEventListener('click', function() {
      const selectedBox = document.querySelector('.product-box input[type="radio"]:checked');
      if (selectedBox) {
        const unitText = selectedBox.closest('.product-box').querySelector('.unit-text').textContent;
